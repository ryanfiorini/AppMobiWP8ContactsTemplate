...
function loadWebScript() {
	...
	script.onload = function() {
		console.log('got cloud-based appmobi.js');
	}
	script.src = "https://d3ezoyt41ban9s.cloudfront.net/javascript/web/3.4.0/appmobi.js";
	head.appendChild(script);
}

//try to load this script - set AppMobiLocalFlag so that the script below will get executed
function loadStaticScript() {
	AppMobiLocalFlag = true;
	var script = document.createElement("script");
	script.type = "text/javascript";
	//if fail, just log
	script.onerror = function() {
		console.log('unable to load any appmobi.js');
	}
	script.onload = function() {
		console.log('got local static appmobi.js');
	}
	script.src = "appmobi_local_bootstrap.js";
	head.appendChild(script);
}

//use local static script
if(typeof AppMobiLocalFlag != "undefined") {
